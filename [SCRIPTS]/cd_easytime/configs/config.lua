...
Config.FrameworkTriggers = { --You can change the esx/qbcore events (IF NEEDED).
    main = 'exile:getsharedobject',   --ESX = 'exile:getsharedobject'   QBCORE = 'QBCore:GetObject'
...
Config.RainChance = 0 --The percent chance for it to rain out of 100.
Config.SnowChance = 100 --The percent chance for it to snow out of 100.
Config.ThunderChance = 0 --The percent chance for it to thunder when raining out of 100.
