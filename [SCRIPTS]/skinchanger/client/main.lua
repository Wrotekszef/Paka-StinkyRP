local Components = {
	...
	{label = _U('helmet_1'),				name = 'helmet_1',			value = -1,		min = -1,	zoomOffset = 0.6,		camOffset = 0.65, restrictMale = {1, 16, 17, 18, 31, 32, 33, 35, 36, 38, 39, 117, 150, 203, 40, 41, 46, 47, 48, 49, 50, 51, 52, 53, 57, 59, 62, 67, 68, 69, 70, 71, 72, 73, 74, 75, 78, 79, 80, 81, 82, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 98, 111, 112, 115, 116, 118, 119, 123, 124, 125, 126, 127, 128, 129, 134},	componentId	= 0},
...
function GetMaxVals(ped)
	return {
		...
		hair_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 2) - 1,
		hair_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 2, Character['hair_1']) - 1,
		hair_3          = #Decorations[(GetEntityModel(PlayerPedId()) ~= `mp_f_freemode_01` and 1 or 2)],
		...
		bodyb_2			= 10,
		ears_1			= GetNumberOfPedPropDrawableVariations	(PlayerPedId(), 2) - 1,
		ears_2			= GetNumberOfPedPropTextureVariations	(PlayerPedId(), 2, Character['ears_1'] - 1),
		tshirt_1		= GetNumberOfPedDrawableVariations		(PlayerPedId(), 8) - 1,
		tshirt_2		= GetNumberOfPedTextureVariations		(PlayerPedId(), 8, Character['tshirt_1']) - 1,
		torso_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 11) - 1,
		torso_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 11, Character['torso_1']) - 1,
		decals_1		= GetNumberOfPedDrawableVariations		(PlayerPedId(), 10) - 1,
		decals_2		= GetNumberOfPedTextureVariations		(PlayerPedId(), 10, Character['decals_1']) - 1,
		arms			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 3) - 1,
		arms_2			= 10,
		pants_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 4) - 1,
		pants_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 4, Character['pants_1']) - 1,
		shoes_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 6) - 1,
		shoes_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 6, Character['shoes_1']) - 1,
		mask_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 1) - 1,
		mask_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 1, Character['mask_1']) - 1,
		bproof_1		= GetNumberOfPedDrawableVariations		(PlayerPedId(), 9) - 1,
		bproof_2		= GetNumberOfPedTextureVariations		(PlayerPedId(), 9, Character['bproof_1']) - 1,
		chain_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 7) - 1,
		chain_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 7, Character['chain_1']) - 1,
		bags_1			= GetNumberOfPedDrawableVariations		(PlayerPedId(), 5) - 1,
		bags_2			= GetNumberOfPedTextureVariations		(PlayerPedId(), 5, Character['bags_1']) - 1,
		helmet_1		= GetNumberOfPedPropDrawableVariations	(PlayerPedId(), 0) - 1,
		helmet_2		= GetNumberOfPedPropTextureVariations	(PlayerPedId(), 0, Character['helmet_1']) - 1,
		glasses_1		= GetNumberOfPedPropDrawableVariations	(PlayerPedId(), 1) - 1,
		glasses_2		= GetNumberOfPedPropTextureVariations	(PlayerPedId(), 1, Character['glasses_1'] - 1),
		watches_1		= GetNumberOfPedPropDrawableVariations	(PlayerPedId(), 6) - 1,
		watches_2		= GetNumberOfPedPropTextureVariations	(PlayerPedId(), 6, Character['watches_1']) - 1,
		bracelets_1		= GetNumberOfPedPropDrawableVariations	(PlayerPedId(), 7) - 1,
		bracelets_2		= GetNumberOfPedPropTextureVariations	(PlayerPedId(), 7, Character['bracelets_1'] - 1),
		nose_1			= 20,
		nose_2			= 20,
		nose_3			= 20,
		nose_4			= 20,
...
function ApplySkin(skin, clothes)
	...
	SetPedHeadBlendData(PlayerPedId(), Character['face'], Character['face_2'], Character['face_3'], Character['skin'], Character['skin_2'], Character['skin_3'], Character['blend_face'] / 10, Character['blend_skin'] / 10, Character['blend'] / 10, true)
	if Character['hair_3'] and Character['hair_3'] ~= 0 and Decorations[Character['sex'] + 1] then
		...
		if decor then
			SetPedFacialDecoration(PlayerPedId(), decor[1], decor[2])
		end
	end

	SetPedHairColor				(PlayerPedId(),			Character['hair_color_1'],		Character['hair_color_2'])					-- Hair Color
	SetPedHeadOverlay			(PlayerPedId(), 3,		Character['age_1'],				(Character['age_2'] / 10) + 0.0)			-- Age + opacity
	SetPedHeadOverlay			(PlayerPedId(), 1,		Character['beard_1'],			(Character['beard_2'] / 10) + 0.0)			-- Beard + opacity
	SetPedEyeColor				(PlayerPedId(),			Character['eye_color'], 0, 1)												-- Eyes color
	SetPedHeadOverlay			(PlayerPedId(), 2,		Character['eyebrows_1'],		(Character['eyebrows_2'] / 10) + 0.0)		-- Eyebrows + opacity
	SetPedHeadOverlay			(PlayerPedId(), 0,		Character['blemishes_1'],		(Character['blemishes_2'] / 10) + 0.0)		-- Blemishes + opacity
	SetPedHeadOverlay			(PlayerPedId(), 4,		Character['makeup_1'],			(Character['makeup_2'] / 10) + 0.0)			-- Makeup + opacity
	SetPedHeadOverlay			(PlayerPedId(), 8,		Character['lipstick_1'],		(Character['lipstick_2'] / 10) + 0.0)		-- Lipstick + opacity
	SetPedComponentVariation	(PlayerPedId(), 2,		Character['hair_1'],			Character['hair_2'], 2)						-- Hair
	SetPedHeadOverlayColor		(PlayerPedId(), 1, 1,	Character['beard_3'],			Character['beard_4'])						-- Beard Color
	SetPedHeadOverlayColor		(PlayerPedId(), 2, 1,	Character['eyebrows_3'],		Character['eyebrows_4'])					-- Eyebrows Color
	SetPedHeadOverlayColor		(PlayerPedId(), 4, 1,	Character['makeup_3'],			Character['makeup_4'])						-- Makeup Color
	SetPedHeadOverlayColor		(PlayerPedId(), 8, 1,	Character['lipstick_3'],		Character['lipstick_4'])					-- Lipstick Color
	SetPedHeadOverlay			(PlayerPedId(), 5,		Character['blush_1'],			(Character['blush_2'] / 10) + 0.0)			-- Blush + opacity
	SetPedHeadOverlayColor		(PlayerPedId(), 5, 2,	Character['blush_3'])														-- Blush Color
	SetPedHeadOverlay			(PlayerPedId(), 6,		Character['complexion_1'],		(Character['complexion_2'] / 10) + 0.0)		-- Complexion + opacity
	SetPedHeadOverlay			(PlayerPedId(), 7,		Character['sun_1'],				(Character['sun_2'] / 10) + 0.0)			-- Sun Damage + opacity
	SetPedHeadOverlay			(PlayerPedId(), 9,		Character['moles_1'],			(Character['moles_2'] / 10) + 0.0)			-- Moles/Freckles + opacity
	SetPedHeadOverlay			(PlayerPedId(), 10,		Character['chest_1'],			(Character['chest_2'] / 10) + 0.0)			-- Chest Hair + opacity
	SetPedHeadOverlayColor		(PlayerPedId(), 10, 1,	Character['chest_3'])														-- Torso Color
	SetPedHeadOverlay			(PlayerPedId(), 11,		Character['bodyb_1'],			(Character['bodyb_2'] / 10) + 0.0)			-- Body Blemishes + opacity

	if Character['ears_1'] == -1 then
		ClearPedProp(PlayerPedId(), 2)
	else
		SetPedPropIndex			(PlayerPedId(), 2,		Character['ears_1'],			Character['ears_2'], 2)						-- Ears Accessories
	end

	SetPedComponentVariation	(PlayerPedId(), 8,		Character['tshirt_1'],			Character['tshirt_2'], 2)					-- Tshirt
	SetPedComponentVariation	(PlayerPedId(), 11,		Character['torso_1'],			Character['torso_2'], 2)					-- torso parts
	SetPedComponentVariation	(PlayerPedId(), 3,		Character['arms'],				Character['arms_2'], 2)						-- Amrs
	SetPedComponentVariation	(PlayerPedId(), 10,		Character['decals_1'],			Character['decals_2'], 2)					-- decals
	SetPedComponentVariation	(PlayerPedId(), 4,		Character['pants_1'],			Character['pants_2'], 2)					-- pants
	SetPedComponentVariation	(PlayerPedId(), 6,		Character['shoes_1'],			Character['shoes_2'], 2)					-- shoes
	SetPedComponentVariation	(PlayerPedId(), 1,		Character['mask_1'],			Character['mask_2'], 2)						-- mask
	SetPedComponentVariation	(PlayerPedId(), 9,		Character['bproof_1'],			Character['bproof_2'], 2)					-- bulletproof
	SetPedComponentVariation	(PlayerPedId(), 7,		Character['chain_1'],			Character['chain_2'], 2)					-- chain
	SetPedComponentVariation	(PlayerPedId(), 5,		Character['bags_1'],			Character['bags_2'], 2)						-- Bag

	if Character['helmet_1'] == -1 then
		ClearPedProp(PlayerPedId(), 0)
	else
		SetPedPropIndex			(PlayerPedId(), 0,		Character['helmet_1'],			Character['helmet_2'], 2)					-- Helmet
	end

	if Character['glasses_1'] == -1 then
		ClearPedProp(PlayerPedId(), 1)
	else
		SetPedPropIndex			(PlayerPedId(), 1,		Character['glasses_1'],			Character['glasses_2'], 2)					-- Glasses
	end

	if Character['watches_1'] == -1 then
		ClearPedProp(PlayerPedId(), 6)
	else
		SetPedPropIndex			(PlayerPedId(), 6,		Character['watches_1'],			Character['watches_2'], 2)					-- Watches
	end

	if Character['bracelets_1'] == -1 then
		ClearPedProp(PlayerPedId(),	7)
	else
		SetPedPropIndex			(PlayerPedId(), 7,		Character['bracelets_1'],		Character['bracelets_2'], 2)				-- Bracelets
	end

	if Character['nose_1'] then
		SetPedFaceFeature(PlayerPedId(), 0, Character['nose_1'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 0, 0.0)
	end

	if Character['nose_2'] then
		SetPedFaceFeature(PlayerPedId(), 1, Character['nose_2'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 1, 0.0)
	end

	if Character['nose_3'] then
		SetPedFaceFeature(PlayerPedId(), 2, Character['nose_3'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 2, 0.0)
	end

	if Character['nose_4'] then
		SetPedFaceFeature(PlayerPedId(), 3, Character['nose_4'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 3, 0.0)
	end

	if Character['nose_5'] then
		SetPedFaceFeature(PlayerPedId(), 4, Character['nose_5'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 4, 0.0)
	end

	if Character['nose_6'] then
		SetPedFaceFeature(PlayerPedId(), 5, Character['nose_6'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 5, 0.0)
	end

	if Character['eyebrow_1'] then
		SetPedFaceFeature(PlayerPedId(), 6, Character['eyebrow_1'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 6, 0.0)
	end

	if Character['eyebrow_2'] then
		SetPedFaceFeature(PlayerPedId(), 7, Character['eyebrow_2'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 7, 0.0)
	end

	if Character['cheeks_1'] then
		SetPedFaceFeature(PlayerPedId(), 8, Character['cheeks_1'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 8, 0.0)
	end

	if Character['cheeks_2'] then
		SetPedFaceFeature(PlayerPedId(), 9, Character['cheeks_2'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 9, 0.0)
	end

	if Character['cheeks_3'] then
		SetPedFaceFeature(PlayerPedId(), 10, Character['cheeks_3'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 10, 0.0)
	end

	if Character['lips'] then
		SetPedFaceFeature(PlayerPedId(), 12, Character['lips'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 12, 0.0)
	end

	if Character['jaw_1'] then
		SetPedFaceFeature(PlayerPedId(), 11, Character['jaw_1'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 11, 0.0)
	end

	if Character['jaw_2'] then
		SetPedFaceFeature(PlayerPedId(), 13, Character['jaw_2'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 13, 0.0)
	end

	if Character['chimp_1'] then
		SetPedFaceFeature(PlayerPedId(), 14, Character['chimp_1'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 14, 0.0)
	end

	if Character['chimp_2'] then
		SetPedFaceFeature(PlayerPedId(), 15, Character['chimp_2'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 15, 0.0)
	end

	if Character['chimp_3'] then
		SetPedFaceFeature(PlayerPedId(), 16, Character['chimp_3'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 16, 0.0)
	end

	if Character['chimp_4'] then
		SetPedFaceFeature(PlayerPedId(), 17, Character['chimp_4'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 17, 0.0)
	end

	if Character['neck'] then
		SetPedFaceFeature(PlayerPedId(), 18, Character['neck'] / 10 - 1.0)
	else
		SetPedFaceFeature(PlayerPedId(), 18, 0.0)
	end
