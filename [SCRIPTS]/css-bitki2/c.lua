...
RegisterNetEvent("bitkiorg2C:acceptLose")
AddEventHandler("bitkiorg2C:acceptLose", function(org, orgName, sender, recipient, tId)
  ...
  local elements = {
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'wonrequest', {
        ...
        TriggerServerEvent("bitkiorg2S:winResult", pendingAccept, organizationname, forwarder, accepter, screenshot, "accept", ajdi)
        pendingAccept = nil
      end
			menu.close()
      ...
      if pendingAccept then
        ...
        TriggerServerEvent("bitkiorg2S:winResult", pendingAccept, screenshot, "deny", ajdi)
        pendingAccept = nil
      end 
			menu.close()
		end
  ...
  CreateThread(function() 
    ...
    if pendingAccept ~= nil then
      ...
      TriggerServerEvent("bitkiorg2S:winResult", pendingAccept, organizationname, forwarder, accepter, screenshot, "timeout", ajdi)
      pendingAccept = nil
      ESX.UI.Menu.CloseAll()
    end  
  end)
