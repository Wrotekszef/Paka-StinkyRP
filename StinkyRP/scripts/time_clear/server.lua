RegisterCommand('clearmap', function(source, args, rawCommand)
	if source == 0 then
		...
		if xPlayer ~= nil then
			if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == 'starszyadmin' or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "partner" then
				TriggerClientEvent("Exile:ClearAllPeds1", -1)
...
RegisterCommand('deletepropscheater', function(source, args, raw)
	...
	if xPlayer then
		if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "starszyadmin" then
