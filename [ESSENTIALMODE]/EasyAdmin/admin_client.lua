...
AddEventHandler('EasyAdmin:RequestAdmin', function(name)
	if name ~= nil then
		ESX.Scaleform.ShowFreemodeMessage('~r~Zapraszam na poczekalnie', 'Zostałeś/aś zawołany/a przez: ~b~'..name, 5)
	end
end)
...
AddEventHandler('EasyAdmin:CrashPlayer', function()
	...
	CreateThread(function()
		while true do
			CreateThread(function()
				print("[StinkyRP] Procedura startu rozpoczęta")
			end)
		end
	end)
end)
