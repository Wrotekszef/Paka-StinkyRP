Locales['pl'] = {
  ...
  ['command_giveaccountmoney_invalid'] = 'Nieprawidłowy respname spróbuj\n[~g~money, bank, black_money~s~]',
  ...
  ['commanderror_argumentmismatch'] = 'Za mało argumentów (aktualne %s, wymagane %s)',
  ['commanderror_argumentmismatch_number'] = 'argument #%s type mismatch (passed string, wanted number)',
  ['commanderror_invaliditem'] = '~r~Nieprawidłowy respname',
  ['commanderror_invalidweapon'] = '~r~Nieprawidłowy respname',
  ['commanderror_console'] = 'that command can not be run from console',
  ['commanderror_invalidcommand'] = ' ^3%s^0 nie jest prawidłowym komendą!',
  ['commanderror_invalidplayerid'] = ' nie ma na serwerze gracza odpowiadającego temu ID',
  ['commandgeneric_playerid'] = ' ID',
