	...
	CreateThread(function()
		while true do
			...
			for _, xPlayer in pairs(xPlayers) do
				...
				-- if xPlayer.job.name == 'police' or xPlayer.job.name == 'sheriff' or xPlayer.job.name == 'ambulance' or xPlayer.job.name == 'mechanik' or xPlayer.job.name == 'gheneraugarage' then
				-- 	xPlayer.addInventoryItem('prezenty', 10)
				-- 	local chanceToDrop = math.random(1, 100)
				-- 	if chanceToDrop < 2 then
				-- 		xPlayer.addInventoryItem('pierniki', 1)
				-- 	end
				-- end
				xPlayer.addInventoryItem('exilecoin', 5)
