...
AddEventHandler('esx:gitestveInventoryItem', function(target, type, itemName, itemCount)
	...
	if type == 'item_standard' or type == 'item_weapon' or type == 'item_sim' then
		...
		if itemCount > 0 and sourceItem.count >= itemCount then
			if targetXPlayer.canCarryItem(itemName, itemCount) then
				...
				TriggerClientEvent('sendProximityMessageDo', -1, playerId, playerId, "Przekazuje przedmiot "..sourceItem.label.. " w ilości "..itemCount)
	...
	elseif type == 'item_account' then
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
			...
			sourceXPlayer.showNotification('~o~Przekazywanie pieniędzy graczowi')
			Wait(5000)
			...
			TriggerClientEvent('sendProximityMessageDo', -1, playerId, playerId, "Przekazuje pieniądze w ilości "..ESX.Math.GroupDigits(itemCount).. "$")
	...
	if type == 'item_standard' or type == 'item_weapon' or type == 'item_sim' then
		if itemCount == nil or itemCount < 1 then
			...
			if (itemCount > xItem.count or xItem.count < 1) then
				...
				TriggerClientEvent('sendProximityMessageDo', -1, playerId, playerId, "Upuścił przedmiot ["..xItem.label.." - "..itemCount.."x]")
	...
	elseif type == 'item_account' then
		if itemCount == nil or itemCount < 1 then
			...
			if (itemCount > account.money or account.money < 1) then
				...
				TriggerClientEvent('sendProximityMessageDo', -1, playerId, playerId, "Upuścił pieniądze w ilości "..ESX.Math.GroupDigits(itemCount).. "$")
...
ConfigDC.DiscordRoles = {
    ['823182171773730817'] = 'best', -- Zarząd
