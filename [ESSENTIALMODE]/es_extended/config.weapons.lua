...
Config.Weapons = {
...

	{
		...
		take_ammo = 'clip',
		components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('COMPONENT_GLOCK_CLIP_01') },
            { name = 'clip_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_GLOCK_CLIP_02') },
	...
	{name = 'WEAPON_MARKSMANPISTOL', label = _U('weapon_marksmanpistol'), tints = Config.DefaultWeaponTints, components = {}, item = "marksmanpistol", ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_PISTOL')}},
	...
	{name = 'WEAPON_DBSHOTGUN', take_ammo = 'shotgunclip', label = _U('weapon_dbshotgun'), item = 'dbshotgun', tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')}},
	{name = 'WEAPON_AUTOSHOTGUN', take_ammo = 'shotgunclip', label = _U('weapon_autoshotgun'), item = 'autoshotgun', tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')}},
	{name = 'WEAPON_MUSKET', take_ammo = 'shotgunclip', label = _U('weapon_musket'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_SNIPER')}, item = 'musket'},
	...
	{name = 'WEAPON_MINIGUN', item = "minigun", take_ammo = 'clipaddons', label = _U('weapon_minigun'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_MINIGUN')}},
	{name = 'WEAPON_RAILGUN', item = "railgun", take_ammo = false, label = _U('weapon_railgun'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RAILGUN')}},
	...
	{name = 'WEAPON_HOMINGLAUNCHER', item = "hominglauncher", take_ammo = false, label = _U('weapon_hominglauncher'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rockets'), hash = GetHashKey('AMMO_HOMINGLAUNCHER')}},
	{name = 'WEAPON_GRENADELAUNCHER', item = "grenadelauncher", take_ammo = false, label = _U('weapon_grenadelauncher'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = GetHashKey('AMMO_GRENADELAUNCHER')}},
	{name = 'WEAPON_COMPACTLAUNCHER', item = "compactlauncher", take_ammo = false, label = _U('weapon_compactlauncher'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = GetHashKey('AMMO_GRENADELAUNCHER')}},
	{name = 'WEAPON_FLAREGUN', item = "flaregun", take_ammo = false, label = _U('weapon_flaregun'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_flaregun'), hash = GetHashKey('AMMO_FLAREGUN')}},
	{name = 'WEAPON_FIREEXTINGUISHER', item = "fireextinguisher", take_ammo = false, label = _U('weapon_fireextinguisher'), components = {}, ammo = {label = _U('ammo_charge'), hash = GetHashKey('AMMO_FIREEXTINGUISHER')}},
	{name = 'WEAPON_PETROLCAN', item = "petrolcan", take_ammo = false, label = _U('weapon_petrolcan'), components = {}, ammo = {label = _U('ammo_petrol'), hash = GetHashKey('AMMO_PETROLCAN')}},
	{name = 'WEAPON_FIREWORK', item = "firework", take_ammo = false, label = _U('weapon_firework'), components = {}, ammo = {label = _U('ammo_firework'), hash = GetHashKey('AMMO_FIREWORK')}},
	{name = 'WEAPON_FLASHLIGHT', item = "flashlight", take_ammo = false, label = _U('weapon_flashlight'), components = {}},
	{name = 'GADGET_PARACHUTE', item = "parachute", take_ammo = false, label = _U('gadget_parachute'), components = {}},
	{name = 'GADGET_NIGHTVISION', item = "nightvision", take_ammo = false, label = _U('gadget_nightvision'), components = {}},
	{name = 'WEAPON_KNUCKLE', item = "knuckle", take_ammo = false, label = _U('weapon_knuckle'), components = {}},
	{name = 'WEAPON_HATCHET', item = "hatchet", take_ammo = false, label = _U('weapon_hatchet'), components = {}},
	{name = 'WEAPON_MACHETE', item = "machete", take_ammo = false, label = _U('weapon_machete'), components = {}},
	{name = 'WEAPON_SWITCHBLADE', item = "switchblade", take_ammo = false, label = _U('weapon_switchblade'), components = {}},
	{name = 'WEAPON_DAGGER', item = "dagger", take_ammo = false, label = _U('weapon_dagger'), components = {}},
	{name = 'WEAPON_POOLCUE', item = "poolcue", take_ammo = false, label = _U('weapon_poolcue'), components = {}},
	{name = 'WEAPON_WRENCH', item = "wrench", take_ammo = false, label = _U('weapon_wrench'), components = {}},
	{name = 'WEAPON_BATTLEAXE', item = "battleaxe", take_ammo = false, label = _U('weapon_battleaxe'), components = {}},
	{name = 'WEAPON_KNIFE', item = "knife", take_ammo = false, label = _U('weapon_knife'), components = {}},
	{name = 'WEAPON_NIGHTSTICK', item = "nightstick", take_ammo = false, label = _U('weapon_nightstick'), components = {}},
	{name = 'WEAPON_HAMMER', item = "hammer", take_ammo = false, label = _U('weapon_hammer'), components = {}},
	{name = 'WEAPON_BAT', item = "bat", take_ammo = false, label = _U('weapon_bat'), components = {}},
	{name = 'WEAPON_GOLFCLUB', item = "golfclub", take_ammo = false, label = _U('weapon_golfclub'), components = {}},
	{name = 'WEAPON_CROWBAR', item = "crowbar", take_ammo = false, label = _U('weapon_crowbar'), components = {}},
