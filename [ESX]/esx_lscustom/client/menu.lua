					...
					if i >= menu.from and i <= menu.to then
						if menu.selected == i then
							...
							if btn.sprite ~= nil then
								...
								elseif btn.sprite == 'locked' then
									DrawSprite("commonmenu", "shop_box_crossb", x + (width/2.4), y, scale/10 -0.01, scale/10 +0.01, 0.00,cfg.text_color.r,cfg.text_color.g,cfg.text_color.b,cfg.text_color.a)
								end
							...
							if btn.sprite ~= nil then
								...
								elseif btn.sprite == 'locked' then
									DrawSprite("commonmenu", "shop_box_cross", x + (width/2.4), y, scale/10 -0.01, scale/10 +0.01, 0.00,cfg.text_color.r,cfg.text_color.g,cfg.text_color.b,cfg.text_color.a)
								end
							elseif btn.price ~= nil then
								if btn.price ~= 0 then
									if not btn.purchased then
