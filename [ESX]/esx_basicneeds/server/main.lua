...
RegisterCommand('heal', function(source, args, user)
    local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer then
		if xPlayer.group == 'best' or xPlayer.group == 'superadmin' or xPlayer.group == 'partner' or xPlayer.getGroup() == 'starszyadmin' or xPlayer.getGroup() == 'starszymod' or xPlayer.group == 'admin' or xPlayer.group == 'mod' or xPlayer.group == 'support' or xPlayer.group == 'trialsupport' then
			if args[1] then
				...
				if target ~= nil then
					...
					if GetPlayerName(target) then
						...
						exports['exile_logs']:SendLog(source, "Użyto komendy /heal na: " .. target, "admin_commands")
					else
				...
				exports['exile_logs']:SendLog(source, "Użyto komendy /heal ", "admin_commands")
