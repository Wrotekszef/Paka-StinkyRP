	...
	while true do
		...
		for k,v in pairs(Config.Zones) do
			if #(coords - vec3(v.Pos.x, v.Pos.y, v.Pos.z)) < Config.DrawDistance then
				sleep = false
				ESX.ShowFloatingHelpNotification('Przeglądaj katalog z ubraniami', vec3(v.Pos.x, v.Pos.y, v.Pos.z+0.90))
				ESX.DrawBigMarker(vec3(v.Pos.x, v.Pos.y, v.Pos.z+0.09))
			end
		end
