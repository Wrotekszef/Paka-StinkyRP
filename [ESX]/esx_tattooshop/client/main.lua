...
CreateThread(function()
	while true do
		...
		for k, v in pairs(Config.Zones) do
			if #(coords - vec3(v.x, v.y, v.z)) < 3 then
				sleep = false				
				ESX.ShowFloatingHelpNotification('Przeglądaj katalog z tatuażami', vec3(v.x, v.y, v.z+0.9))
				ESX.DrawMarker(vec3(v.x, v.y, v.z+0.09))
			end
		end
