...
CreateThread(function()
	...
	while true do
		...
		if IsEntityDead(PlayerPedId()) then
			...
			if DeathReason == "Popełnił samobójstwo" or DeathReason == "Zabił" then
