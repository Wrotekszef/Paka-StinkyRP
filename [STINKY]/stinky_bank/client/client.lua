        ...
        if isNearSomething ~= nil then
            if isNearSomething.type == "BANK" then
                ...
                if IsControlJustPressed(1, 38) then
                    ...
                    TriggerServerEvent('stinky_bank:balance')
                end
...
GetClosestBankOrATM = function()
  ...
  AddEventHandler('currentbalance1', function(balance)
      ESX.TriggerServerCallback('stinky_bank:character', function(result)
  ...
  RegisterNUICallback('deposit', function(data)
      TriggerServerEvent('stinky_bank:deposit', tonumber(data.amount))
      TriggerServerEvent('stinky_bank:balance')
  end)
  ...
  RegisterNUICallback('withdrawl', function(data)
      ...
      TriggerServerEvent('stinky_bank:withdraw', tonumber(data.amountw))
      TriggerServerEvent('stinky_bank:balance')
  ...
  RegisterNUICallback('transfer', function(data)
      TriggerServerEvent('stinky_bank:transfer', data.to, data.amountt, data.anon, data.contestt)
      TriggerServerEvent('stinky_bank:balance')
  end)
